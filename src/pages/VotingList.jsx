...
const [filterDateFrom, setFilterDateFrom] = useState('');
  ...
  const [filterTheme, setFilterTheme] = useState(''); // Aktivní filtr aplikovaný na data
  const [themeInputValue, setThemeInputValue] = useState(''); // Text zadaný v políčku
  const [showThemeSuggestions, setShowThemeSuggestions] = useState(false); // Viditelnost našeptávače
  ...
  return (
    <div className="app-layout relative">
      ...
      <div className="relative z-10">
        ...
        {(filterResult || filterTheme || themeInputValue || filterDateFrom || filterDateTo || searchQuery) && (
          <button
            onClick={() => { setFilterResult(''); setFilterTheme(''); setThemeInputValue(''); setFilterDateFrom(''); setFilterDateTo(''); setSearchQuery(''); setPage(1); }}
